...
for(const [folder,file,budget]of [['forge','mushroom-green-forge.glb',12_000_000],['village','cottages.glb',16_000_000],['chainmaker','chainmaker.glb',4_000_000],['interior-objects','catalogue.glb',6_000_000]]){
