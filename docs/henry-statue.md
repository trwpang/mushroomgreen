...
The model faces +X in its original coordinates. The room instance keeps that orientation to face into the room. Its 186 × 218 mm base sits at local X −3.74, Z −0.87, on the quarry-tile surface. The coal bucket moves to Z +0.87 on the other side of the fireplace. The old shelf and its brackets are removed.
