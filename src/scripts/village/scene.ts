...
import { renderedRoads,brooks,boundary,greens,project,ground,prepareGround,weaverWorkshop,makeHomes,nearestRoad,nearestVillageRoad,nearestSegment,localPoint,streamDistance,chainshopPosition,chainshopReplacesHouse,type Point,type Home,type Household } from './layout';
...
const historic=addHistoricLandscape(scene),smallShops=addBackyardWorkshops(scene,backyardShops),plots=addYardPlots(scene,yardPlots);
