...
function roomBounds(){const h=roomHome!;return {x:h.x,z:h.z,angle:h.angle,width:[6.4,7.2,9.2][h.style]*h.sx,depth:[4.6,4.8,4.5][h.style]*h.sz,floor:h.height+.12,ceiling:h.height+2.22};}
